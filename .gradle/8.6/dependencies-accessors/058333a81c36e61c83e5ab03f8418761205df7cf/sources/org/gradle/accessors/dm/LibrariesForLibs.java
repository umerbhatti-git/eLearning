...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ParcelerLibraryAccessors laccForParcelerLibraryAccessors = new ParcelerLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>parceler</b>
     */
    public ParcelerLibraryAccessors getParceler() {
        return laccForParcelerLibraryAccessors;
    }
    ...
    public static class ParcelerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public ParcelerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>parceler</b> with <b>org.parceler:parceler-api</b> coordinates and
         * with version reference <b>parceler</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("parceler");
        }

        /**
         * Dependency provider for <b>processor</b> with <b>org.parceler:parceler</b> coordinates and
         * with version reference <b>parceler</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getProcessor() {
            return create("parceler.processor");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>parceler</b> with value <b>1.1.12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getParceler() { return getVersion("parceler"); }
